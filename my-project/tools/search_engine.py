...
canvas_location = pyautogui.locateOnScreen('canvas_image.png')
if canvas_location:
    canvas_x = canvas_location.left + canvas_location.width // 2
    canvas_y = canvas_location.top + canvas_location.height // 2
